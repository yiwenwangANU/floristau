    ...
    <NavigationMenu.Root className="relative z-10 flex w-screen justify-center">
      ...
      <div className="perspective-[2000px] absolute left-0 top-full flex w-full justify-center">
        <NavigationMenu.Viewport
          className="relative mt-2.5 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-[top_center] overflow-hidden rounded-md bg-white sm:w-[var(--radix-navigation-menu-viewport-width)]
